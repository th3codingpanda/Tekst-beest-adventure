...
namespace Tekst_beest_adventure
{
    public class FinalBoss
    {
        public FinalBoss(Player aPlayer)
        {
            ...
            Enemy PERFECTCELL = new Enemy("The perfect being PERFECT CELL", 25, 2147483647, Magics.Magic.Perfect_Cell, true, true);
            Move Beam_Attack = new Move(Magics.Magic.Perfect_Cell, 0, 7, $"Beam attack");
            Move Absorb = new Move(Magics.Magic.Perfect_Cell, 0, 8, $"Absorb");
            Move Clone_Attack = new Move(Magics.Magic.Perfect_Cell, 0, 6, $"Clone attack");
